...
class LineDetection():
    def __init__(self, buffersize, bufferfill, croptop, approach_croptop, cropbottom, cropside, maxwhite, minslope, linelength, linedistance, debug, use_yellow, followingdirection):
